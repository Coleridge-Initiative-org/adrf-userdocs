...
author = 'Graham Henke, Daniela Hochfellner'
...
html_logo = 'images/adrf_horizontal_small.png'
...
latex_documents = [
    (master_doc, 'ADRF.tex', 'ADRF Documentation',
     'Graham Henke', 'manual'),
]
...
man_pages = [
    (master_doc, 'ADRF', 'ADRF Documentation',
     [author], 1)
]
