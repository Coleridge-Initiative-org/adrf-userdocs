...
Accessing the ADRF
------------------
All users of the ADRF need to be uniquely identified and need to authenticate when accessing the Facility. Thus, access is implemented through a two factor authentication software. This means you login to your account with unique credentials and password, and a one time password obtained from a authentication app.
